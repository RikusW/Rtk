...
RDRAWER(RdWin4Control)
RDRAWER(RdWin4TBox)
RDRAWER(RdWin4Window)
RDRAWER(RdWin4TabControl)

RDRAWER(RdWin4Button)
RDRAWER(RdWin4ComboBox)
RDRAWER(RdWin4Label)
RDRAWER(RdWin4MenuButton)
RDRAWER(RdWin4CheckBox)
RDRAWER(RdWin4RadioButton)
RDRAWER(RdWin4ToggleButton)
RDRAWER(RdWin4TextEdit)
RDRAWERX(RdWin4TreeView)
void DrawNode(RTreeView *tv,int x,int &y,RTreeNode *n, RGraphics *g); };
RDRAWERX(RdWin4ListView)
void DrawNode(RListView *lv,int x,int y,SListNode *n, RGraphics *g); };
RDRAWER(RdWin4ToolTip)
RDRAWER(RdWin4EditBox)
RDRAWER(RdWin4Range)
RDRAWERX(RdWin4ScrollBar)
void DrSbButton(RControl *rc, RGraphics *g, int left, int top, int right, int bottom, bool b); };
RDRAWER(RdWin4ProgressBar)
RDRAWER(RdWin4StatusBar)

//-----------------------------------------------------------------------------++++
// RDrawer

void RdWin4Control::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4Control::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 20;
	y = 20;
}
...
void RdWin4TBox::Draw(RControl *rc, RGraphics *g)
{
	RTBox *r = (RTBox*)rc;
...
void RdWin4TBox::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 20;
	y = 20;
}
...
void RdWin4Window::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4Window::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 20;
	y = 20;
}
...
void RdWin4TabControl::Draw(RControl *rc, RGraphics *g)
{
//#ifdef CLIPTEST
...
void RdWin4TabControl::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 20;
	y = 20;
}
...
void RdWin4Button::Draw(RControl *rc, RGraphics *g)
{
	...
	g->SetTextColor(r->bDisabled ? g->cGrayText : r->IsHit() ? g->rgb(100,100,100):g->rgb(0,0,0),g->c3DFace);
	g->TextOut(r->left+8,r->top+6,r->text,strlen(r->text));
	
	DrButton(r,g,r->bPushed);
}

void RdWin4Button::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4ComboBox::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4ComboBox::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4Label::Draw(RControl *rc, RGraphics *g)
{
	RLabel *r = (RLabel*)rc;
...
void RdWin4Label::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 16;
}
...
void RdWin4MenuButton::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4MenuButton::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4CheckBox::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4CheckBox::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4RadioButton::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4RadioButton::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4ToggleButton::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4ToggleButton::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 80;
	y = 24;
}
...
void RdWin4TextEdit::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4TextEdit::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4TreeView::DrawNode(RTreeView *tv,int x,int &y,RTreeNode *n, RGraphics *g)
{
	if(!n) return;
	int i,s = n->GetDepth();
	int stack[40];
...
void RdWin4TreeView::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4TreeView::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 20;
	y = 20;
}
...
void RdWin4ToolTip::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4ToolTip::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4EditBox::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4EditBox::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 100;
	y = 24;
}
...
void RdWin4Range::Draw(RControl *rc, RGraphics *g)
{
	RRange *r = (RRange*)rc;
	g->FillRect(g->c3DFace,r->left,r->top,r->width,r->height);
...
void RdWin4Range::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 24;
	y = 24;
}
...
void RdWin4ScrollBar::DrSbButton(RControl *rc, RGraphics *g, int left, int top, int right, int bottom, bool b)
{
...
void RdWin4ScrollBar::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4ScrollBar::GetMinSize(RControl *rc, int &x, int &y)
{
	if(rc->align & AL_V) {
		x = 16;
		y = 50;
...
void RdWin4ProgressBar::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4ProgressBar::GetMinSize(RControl *rc, int &x, int &y)
{
	if(rc->align & AL_V) {
		x = 16;
		y = 50;
...
void RdWin4StatusBar::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4StatusBar::GetMinSize(RControl *rc, int &x, int &y)
{
	x = 50;
	y = 20;
}
...
void RdWin4ListView::DrawNode(RListView *lv,int x,int y,SListNode *n, RGraphics *g)
{
	if(!n) {
		return;
	}
...
void RdWin4ListView::Draw(RControl *rc, RGraphics *g)
{
...
void RdWin4ListView::GetMinSize(RControl *rc, int &x, int &y)
{
...
RdWin4CheckBox		rdWin4CheckBox;
RdWin4RadioButton	rdWin4RadioButton;
RdWin4ToggleButton	rdWin4ToggleButton;
RdWin4TextEdit		rdWin4TextEdit;
RdWin4TreeView		rdWin4TreeView;
RdWin4ToolTip		rdWin4ToolTip;
RdWin4EditBox		rdWin4EditBox;
RdWin4ScrollBar		rdWin4ScrollBar;
RdWin4ProgressBar	rdWin4ProgressBar;
RdWin4StatusBar		rdWin4StatusBar;
RdWin4Label			rdWin4Label;
RdWin4ListView		rdWin4ListView;
